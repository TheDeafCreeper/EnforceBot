...
export default new Event('guildScheduledEventDelete', async (event: GuildScheduledEvent) => {
    ...
    server.sendLog('guildScheduledEventDelete', { embeds: [embed.embed] }, null, null)
});
